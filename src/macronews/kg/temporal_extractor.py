...
class LLMTemporalExtractor:
    """3-pass temporal KG extractor backed by vLLM. `model_path` is caller-supplied
    (runner.py defaults it to config.paths.MAPPER_MODEL -- the same model as the
    mapper) rather than hardcoded here.
