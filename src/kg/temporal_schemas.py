...
Supersedes KGFact/modality in src/kg/schemas.py. Reuses ENTITY_TYPES /
RELATION_TYPES (our 19+19 macro vocabularies) from kg.schemas.
"""
...
from kg.schemas import ENTITY_TYPES, RELATION_TYPES
