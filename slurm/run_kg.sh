...
#
# Gold usage:
#   MAPPER_FILE=results/mapping/dev/gold.jsonl \
#     bash slurm/run_kg.sh
#       (defaults to gold dataset -> results/kg/dev/gold.jsonl)
#
# DJNW single-shard usage:
#   MODE=djnw \
#     INPUT_FILE=/nfs/.../articles/2014-05c_clean.jsonl \
#     MAPPER_FILE=results/mapping/prod/2014-ungated/mapper/2014-05c.jsonl \
...
#     MAPPER_DIR=results/mapping/dev/march_2022 \
#     OUTPUT_FILE=results/kg/dev/march_2022_dev.jsonl \
#     bash slurm/run_kg.sh
#
# Env knobs:
#   MODEL_PATH, MAX_MODEL_LEN, MAX_TOKENS,
#   GPU_PARTITION, GPU_ACCOUNT, GPU_QOS, GPU_GRES, WALLTIME, EXCLUDE_NODES   (defaults = FREE B200 tier)
