...
#
# Gold usage:
#   bash slurm/run_grader.sh
#       (defaults to gold dataset, results/groups-v2/gold.jsonl input,
#        results/groups-v2-grader/gold.jsonl output)
#
# DJNW usage:
#   MODE=djnw \
#     MAPPER_OUTPUT=results/mapping/prod/2014-ungated/mapper/2014-05c.jsonl \
#     INPUT_FILE=/nfs/.../articles/2014-05c_clean.jsonl \
#     OUTPUT_FILE=results/mapping/prod/2014-ungated/grader/2014-05c.jsonl \
#     bash slurm/run_grader.sh
#
# Env knobs:
#   MODEL_PATH, MAX_MODEL_LEN, MAX_TOKENS,
#   GPU_PARTITION, GPU_ACCOUNT, GPU_GRES, WALLTIME
...
jobid=$(sbatch --parsable \
    ...
    --wrap="
        ...
        $PY -m macronews.cli mapper grade \
