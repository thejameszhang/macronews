...
#     bash slurm/run_kg_grader.sh
#
# Env knobs: MODEL_PATH, MAX_MODEL_LEN, MAX_TOKENS, GPU_PARTITION, GPU_ACCOUNT, GPU_QOS, GPU_GRES, WALLTIME
...
# Mirrors slurm/run_grader.sh exactly: ${VAR} expands in THIS (outer) shell;
...
jobid=$(sbatch --parsable \
    ...
    --wrap="
        ...
        # pattern as slurm/_run_grader_task.sh.
