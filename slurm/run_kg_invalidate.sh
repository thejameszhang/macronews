...
#     bash slurm/run_kg_invalidate.sh
#
# Env knobs: MODEL_PATH, EMB_OUT, MAX_MODEL_LEN, GPU_PARTITION, GPU_ACCOUNT, GPU_QOS,
#            GPU_GRES, WALLTIME.
set -euo pipefail
...
echo "Walltime: ${WALLTIME}, partition: ${GPU_PARTITION} (FREE tier), gres: ${GPU_GRES}"
